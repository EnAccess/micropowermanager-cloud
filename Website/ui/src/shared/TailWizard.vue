<template>
  <div>
    <md-dialog :md-active.sync="wizardIsVisible" :md-click-outside-to-close="false"
    >
      <md-dialog-content>
          ...
          <md-step class="stepper-step" v-for="(tailObj,index) in tail" :id="tailObj.tag"
            ...
            <div class="exclamation">
              ...
              <div class="md-layout-item md-size-100 exclamation-div">
                <md-button class="md-primary md-block" @click="nextStep(tailObj.tag, tail[index+1])">Do
                  this later.
                </md-button>
              </div>
            </div>
